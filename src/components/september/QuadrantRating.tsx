...
import { QuadrantRatingSuccessPopup } from '@/components/points/QuadrantRatingSuccessPopup';
        ...
        <>
            <div className="flex flex-col flex-1 min-h-0 bg-black">
                ...
                <div className="p-3 sm:p-4 lg:p-6 border-b border-gray-700 flex-shrink-0">
                    {/* Points Status Display - Only for already rated users */}
                    {!isEligibleForPoints && (
