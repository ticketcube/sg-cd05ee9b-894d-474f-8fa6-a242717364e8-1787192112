    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 max-w-6xl w-[95vw] max-h-[90vh] h-[90vh] bg-purple-deep border-4 border-white text-white overflow-hidden rounded-2xl shadow-2xl p-0">
                ...
                <DialogClose asChild>
                    <button 
                        className="absolute right-4 top-4 z-50 rounded-full bg-purple-deep/50 backdrop-blur-sm p-2 text-white hover:bg-purple-deep/70 transition-all duration-200 hover:scale-110"
                        onClick={onClose}
                    >
