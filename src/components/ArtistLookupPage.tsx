             ...
             <div>
               <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            ...
                                            {loading ? (
                                                ...
                                                searchResults.map((artist) => (
                                                    <div
                                                        ...
                                                        className={`p-3 rounded-lg cursor-pointer transition-colors ${selectedArtist?.uuid === artist.uuid
                        ...
                        <Card className="bg-gray-900 border-gray-700">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2 max-h-96 overflow-y-auto">
                                    {!campaignFilterActive && searchResults.map((artist) => (
                                        <div
                                            key={artist.uuid}
                                            onClick={() => handleArtistSelect(artist)}
                                            className={`text-white p-3 rounded-lg cursor-pointer transition-colors ${selectedArtist?.uuid === artist.uuid
                                    ...
                                    {!campaignFilterActive && searchQuery && !loading && searchResults.length === 0 && (
                                        <div className="text-center py-8 text-gray-400">
                                            No artists found matching "{searchQuery}"
                                        </div>
                                    )}
                                    {!campaignFilterActive && !searchQuery && searchResults.length === 0 && (
                                        <div className="text-center py-8 text-gray-400">
                    ...
                    {/* RIGHT COLUMN */}
                    <div className="space-y-6">
                        {/* Create Artist Button - Always Visible */}
                        <Card className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border-purple-500/30">
