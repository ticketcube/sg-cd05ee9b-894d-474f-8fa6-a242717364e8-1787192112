              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    <div>
                      <p className="font-medium text-yellow-900">Completion Bonus</p>
                      <p className="text-sm text-yellow-700">Once per week</p>
                    </div>
                    <Badge className="bg-yellow-100 text-yellow-800">15pts</Badge>
                  </div>
                </CardContent>
              </Card>
