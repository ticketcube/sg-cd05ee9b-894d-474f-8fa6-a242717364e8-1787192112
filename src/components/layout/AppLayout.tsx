...
import { LogOut, LogIn, User, Compass } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            {role === "otwstaff" && (
              <Badge
                variant="secondary"
                className="bg-blue-600 text-white text-xs ml-2"
              >
                OTW Staff
              </Badge>
            )}
                ...
                >
                  <DropdownMenuItem asChild>
                    <Link href="/dashboard" className="flex items-center gap-2">
                      ...
                      <span className="sm:hidden">DDashboard</span>
