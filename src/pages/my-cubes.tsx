...
const CubePreview = ({ cube }: { cube: TicketCube }) => {
  ...
  return (
      <div className="h-200 w-200 mx-auto">
                                      ...
                                      <div className="flex items-center gap-2 mb-4">
                                                     ...
                                                     {cube.is_secured ? (
                                                       ...
                                                       {/* Event, Venue, Date stacked */}
                                                        ...
                                                        <div className="text-white font-medium">{cube.event_name || "No event specified"}
                                                        </div>
                                                      </div>
                                                      <div>
                                          ...
                                          <CubePreview cube={cube} className="absolute inset-0 w-full h-full" />
                                            </div>
                                              </div>
                                             </CardHeader>
