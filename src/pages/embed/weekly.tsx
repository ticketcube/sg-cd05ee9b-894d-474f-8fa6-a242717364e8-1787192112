...
export default function WeeklyEmbedPage() {
    ...
    return (
        <>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight mb-6 text-center text-black">
                ...
                <div className="bg-purple-deep bg-opacity-80 rounded-2xl shadow-lg">
                    <div className="max-w-7xl mx-auto px-4 py-2">
                        <div className="flex items-center justify-between gap-2">
                           ...
                           <div className="flex items-center gap-2 min-w-max px-2 sm:px-6 justify-start sm:justify-center <div className="flex items-center gap-2 min-w-max px-2 sm:px-6 justify-start sm:justify-center
            w-[45vw] sm:w-auto">
