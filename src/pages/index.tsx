                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl md:rounded-2xl p-1.5 md:p-2 border border-white/10 w-full max-w-lg">
                        <div className="flex gap-1 md:gap-2">
                            <button
                                ...
                                className={`flex-1 px-3 md:px-6 py-2 md:py-3 rounded-lg md:rounded-xl font-medium transition-all text-sm md:text-base ${activeTab === "discover"
                            ...
                            <button
                                ...
                                className={`flex-1 px-3 md:px-6 py-2 md:py-3 rounded-lg md:rounded-xl font-medium transition-all text-sm md:text-base ${activeTab === "rewards"
                            ...
                            {user?.role === 'otwstaff' && (
                                <button
                                    ...
                                    className={`flex-1 px-3 md:px-6 py-2 md:py-3 rounded-lg md:rounded-xl font-medium transition-all text-sm md:text-base ${activeTab === "staff"
        ...
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 rounded-xl md:rounded-2xl p-4 md:p-6 border border-yellow-500/30 backdrop-blur-sm">
                <div className="flex items-start gap-3 md:gap-6">
                    <div className={`w-14 md:w-20 h-14 md:h-20 rounded-xl md:rounded-2xl flex items-center justify-center transition-all shadow-lg flex-shrink-0 ${isComplete
