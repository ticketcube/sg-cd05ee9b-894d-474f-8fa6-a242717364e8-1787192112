                            ...
                            <CardContent className="p-6 space-y-6">
                                ...
                                {!selectedFile ? (
                                    ...
                                    >
                                        ...
                                        <h3 className="font-semibold text-white mb-2">Browse Files</h3>
                                        <p className="text-gray-400 text-sm">Select images or videos up to 100MB</p>
                                        <input
                                            ref={fileInputRef}
                                            type="file"
                                            accept="image/*,video/*"
                                    ...
                                    <div className="space-y-4">
                                        <div className="relative bg-gray-800 rounded-lg p-4 border border-gray-700">
                                            ...
                                            {selectedFile.type === "image" ? (
                                                <img src={selectedFile.preview} alt="Preview" className="w-full h-40 object-cover rounded-lg" />
                                            ) : selectedFile.type === "video" ? (
                                                <video src={selectedFile.preview} controls className="w-full h-40 rounded-lg" />
                                            ) : (
                                ...
                                {uploadStatus === "uploading" && (
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-sm text-gray-400 text-center">Uploading your favorite...</p>
                                    </div>
                                )}
                                ...
                                <Button
                                    ...
                                    size="lg"
                                >
                                    {uploadStatus === "uploading" ? "Uploading..." : selectedFile ? "Upload" : "Select a file first"}
                                </Button>
